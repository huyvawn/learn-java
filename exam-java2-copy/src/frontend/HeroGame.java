	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				break;
			case 3: 
				String sqlshowdata = "SELECT * FROM herogame.player p inner join herogame.national n on"
						+ " p.NationalId = n.NationalId;";
				try {
				Connection ketnoi = Connect.getConnection();
			...
			case 4:
				String sqlshow ="select * from herogame.player";
				Connection ketnoi = Connect.getConnection();
				try {
					PreparedStatement statement = ketnoi.prepareStatement(sqlshow);
					ResultSet ketqua = statement.executeQuery();
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
